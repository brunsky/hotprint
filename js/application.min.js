var SANDBOX=!1,HOST_URL="";SANDBOX?(HOST_URL="http://sandbox.hotprintcloud.com/",FBREDIRECT_URL="sandbox_fbredirect.html",INSTAREDIRECT_URL="sandbox_instaredirect.html"):(HOST_URL="http://www.hotprintcloud.com/",FBREDIRECT_URL="fbredirect.html",INSTAREDIRECT_URL="instaredirect.html");
var TEMP_DIR="proxy/tmp/",PHONE_NAME="iphone5",LAYOUT_NAME="layout_3",PHONE_COLOR="white",layout_ox=410,layout_oy=Math.floor(0.1*$(window).height()),CORNER_OPT=0.1,isCornerFading=!1,PAGE="Design",TITLE_NAME="",maskImg,isMenuEntry=!1,_init,_getUserData,_displayUserData,_instaCrossLogin,_instalogin,_instalogout,_getUserRecent,_facebookPhotoAlbum,_fblogin,_fbCrossLogin,_fblogout,_logout,_loadLayout,access_token,user_id,source_type;
...
e=location.hash.split("&")[2];if(b){if("instagram"==b.split("=")[1])_instaCrossLogin(g.split("=")[1]);else if("facebook"==b.split("=")[1])_fbCrossLogin(g.split("=")[1]);else{$.removeCookie("source");$.removeCookie("access_token");parent.location.hash="";return}parent.location.hash="";$.cookie("access_token",g.split("=")[1]);e&&"b"==e.split("=")[0]&&($("body").append('<div class="modalOverlay"></div>'),"succeed"==e.split("=")[1]?new Messi("\u60a8\u5df2\u7d93\u4ed8\u6b3e\u6210\u529f! \u53ef\u4ee5\u96a8\u6642\u6aa2\u8996\u51fa\u8ca8\u9032\u5ea6<br>\u6216\u8005\u7e7c\u7e8c\u8a2d\u8a08\u65b0\u7684\u4f5c\u54c1\u3002",
{title:"\u606d\u559c!",buttons:[{id:0,label:"Close",val:"C"}],callback:function(){$(".modalOverlay").remove();simpleCart.empty()}}):new Messi("\u525b\u525b\u7684\u4ed8\u6b3e\u4e26\u672a\u6210\u529f\uff0c\u60a8\u7684\u4fe1\u7528\u5361\u6c92\u6709\u7522\u751f\u4efb\u4f55\u6263\u6b3e\u8a18\u9304<br><br>\u8acb\u78ba\u8a8d\u4ed8\u6b3e\u6d41\u7a0b\u662f\u5426\u6709\u8aa4\uff0c\u6216\u7a0d\u5f8c\u518d\u8a66\u3002",{title:"\u4ed8\u6b3e\u5931\u6557",buttons:[{id:0,label:"Close",val:"C"}],callback:function(){$(".modalOverlay").remove()}}))}else $.removeCookie("source"),
...
function openFromMainMenu(a){"Checkout"==PAGE?($("body").append('<div class="modalOverlay"></div>'),new Messi("\u60a8\u5c1a\u672a\u5b8c\u6210\u4ed8\u6b3e\u5594!\u78ba\u5b9a\u8981\u53d6\u6d88\u55ce\uff1f",{title:"\u53d6\u6d88\u4ed8\u6b3e",buttons:[{id:0,label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(d){"Y"===d&&(releasePage(PAGE),newPage(a));$(".modalOverlay").remove()}})):"Design"==PAGE&&0!=$(".canvas_appended").length?($("body").append('<div class="modalOverlay"></div>'),new Messi("\u60a8\u78ba\u5b9a\u8981\u96e2\u958b\u8a2d\u8a08\u9801\u9762\u55ce\uff1f\u6240\u6709\u7684\u5716\u7247\u5c07\u6703\u88ab\u6e05\u7a7a\uff01",
{title:"\u96e2\u958b\u8a2d\u8a08\u9801\u9762",buttons:[{id:0,label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(d){"Y"===d&&(removeUnclearWarning("_big"),releasePage(PAGE),newPage(a));$(".modalOverlay").remove()}})):(releasePage(PAGE),newPage(a))}
