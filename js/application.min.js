...
$(this)[0]=null}),$(".layout_corner").each(function(){$(this).remove();$(this)[0]=null})),$(".canvas_appended").length&&$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null})):"Save"==a?($("#start-design").hide(),$("#my-gallery").hide(),$("#galleryCanvas").remove(),$("#galleryCanvas")[0]=null):"Gallery"==a?($("#start-design").hide(),$("#gallery").remove(),$("#gallery")[0]=null,$(".shopping_cart").remove(),$(".shopping_cart")[0]=null):"Checkout"==a&&$(".order").remove()}
