...
$(this).html("");$(this).append($(e.draggable).clone());f($(this).children(".draggable"),g)}$(this).children(".draggable").removeClass("gallery-pool");!1==isCornerFading&&$(".layout_corner").animate({opacity:CORNER_OPT},{complete:function(){$(".layout_corner > .draggable").parent().css("opacity","0")}});$(this).children(".draggable").css({position:"relative",top:"0px",left:"0px",width:$(this).css("width"),height:$(this).css("height"),opacity:"0"});var g=100<parseInt($(this).css("width"),10)||100<
parseInt($(this).css("height"),10)?$(this).children(".draggable").attr("delay_src_h"):$(this).children(".draggable").attr("src"),b=$(this);if(0<=$(this).children(".draggable").attr("class").indexOf("cached")){var j=new Image;"undefined"!=typeof b.children(".draggable").data("zdx")?(g=$("<canvas>"),g[0].width=parseInt(b.css("width"),10)+parseInt(b.css("border-left-width"),10),g[0].height=parseInt(b.css("height"),10)+parseInt(b.css("border-left-width"),10),autoClipper2(b.children(".draggable")[0],g,
b.children(".draggable").data("corner"),b),j.src=g[0].toDataURL(),j.width=g[0].width,j.height=g[0].height):j.src=g;j.onload=function(){0<=b.attr("class").indexOf("layout_circle")?doClipping(doMasking(j,a,b,d,c),b,cirClipper):0<=b.attr("class").indexOf("layout_square")&&doClipping(doMasking(j,a,b,d,c),b,boxClipper);b.css("opacity","0");setDragObj(b);b.droppable("enable")}}else{var k=(new Spinner({lines:13,length:7,width:4,radius:10,corners:1,rotate:0,color:"#000",speed:1,trail:60,shadow:!1,hwaccel:!1,
className:"spinner",zIndex:2E9,top:"auto",left:"auto"})).spin($(this)[0]);$.getImageData({url:g,server:HOST_URL+"proxy/getImageData.php",success:function(a){b.children(".draggable").attr("src",a.src);b.children(".draggable").addClass("cached");autoCentered(b,a);k.stop();b.css("opacity","0");setDragObj(b);b.droppable("enable")},error:function(){k.stop();b.droppable("enable")}})}}},out:function(){0<$(this).children(".draggable").length&&0<=$(this).children(".draggable").attr("class").indexOf("ui-draggable-dragging")&&
