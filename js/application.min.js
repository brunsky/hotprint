...
(function(){function a(a){!1==isMenuEntry&&(isMenuEntry=!0,menuLoadLayout(a.data.param))}function d(a){!1==isMenuEntry&&(isMenuEntry=!0,menuLoadPhone(a.data.param))}function b(a){!1==isMenuEntry&&(isMenuEntry=!0,menuLoadColor(a.data.param))}$.extend({social_connect:function(){_init()}});_init=function(){$("html").removeClass("no-js");$("body").addClass("not-logged-in");$("#login").click({isPopup:!1},_instalogin);$("#login2").click({isPopup:!1},_fblogin);$("#facebook-source-login").click({isPopup:!0},
_fblogin);$("#instagram-source-login").click({isPopup:!0},_instalogin);$(".layout_item").each(function(){$(this).click({param:$(this).attr("id")},a)});$(".phone_item").each(function(){$(this).click({param:$(this).attr("id")},d)});$(".color_item").each(function(){$(this).click({param:$(this).attr("id")},b)});if(""!=location.hash){var g=location.hash.split("&")[0],c=location.hash.split("&")[1],e=location.hash.split("&")[2];if(c){if("instagram"==c.split("=")[1])_instaCrossLogin(g.split("=")[1]);else if("facebook"==
c.split("=")[1])_fbCrossLogin(g.split("=")[1]);else{$.removeCookie("source");$.removeCookie("access_token");parent.location.hash="";return}parent.location.hash="";$.cookie("access_token",g.split("=")[1]);e&&"b"==e.split("=")[0]&&($("body").append('<div class="modalOverlay"></div>'),"succeed"==e.split("=")[1]?new Messi($.i18n.prop("Msg_20"),{title:$.i18n.prop("Msg_21"),buttons:[{id:0,label:"Close",val:"C"}],callback:function(){$(".modalOverlay").remove();simpleCart.empty()}}):new Messi($.i18n.prop("Msg_22"),
{title:$.i18n.prop("Msg_23"),buttons:[{id:0,label:"Close",val:"C"}],callback:function(){$(".modalOverlay").remove()}}))}else $.removeCookie("source"),$.removeCookie("access_token")}else $.cookie("access_token")&&$.cookie("source")&&("instagram"==$.cookie("source")?_instaCrossLogin($.cookie("access_token")):"facebook"==$.cookie("source")?_fbCrossLogin($.cookie("access_token")):($.removeCookie("source"),$.removeCookie("access_token"),parent.location.hash=""))};_bindFunc=function(){$("#save-design").unbind("click");
...
$("#logout").bind("click",_logout);$("#go-to-my-gallery").bind("click",openGallery);$("#go-to-my-order-history").bind("click",openHistory)};_logout=function(){$("body").append('<div class="modalOverlay"></div>');$.removeCookie("source");$.removeCookie("access_token");$.removeCookie("user_id");$.removeCookie("phone_name");$.removeCookie("layout_name");$.removeCookie("phone_color");_fblogout(_instalogout)};var f;_instalogin=function(a){$(".recent").find(".draggable").each(function(){$(this).remove();
$(this)[0]=null});f="";var c="https://instagram.com/oauth/authorize/?client_id="+INSTAGRAM_CLIENT_ID+"&amp;redirect_uri="+HOST_URL+INSTAREDIRECT_URL+"&amp;response_type=token";if(!0==a.data.isPopup)return window.open(c,"hotprintCloud","height=400,width=600,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes"),!1;window.location=c};_instalogout=function(){$.ajax({url:"https://instagram.com/accounts/logout/",dataType:"jsonp",error:function(){location.reload()},
success:function(){location.reload()}})};_instaCrossLogin=function(a){access_token=a;source_type="instagram";null==$.cookie("source")&&$.cookie("source",source_type);$("body").addClass("logged-in");$(".tip").fadeOut(1E3);_getUserData()};_getUserData=function(){$.ajax({dataType:"jsonp",url:"https://api.instagram.com/v1/users/self",data:{access_token:access_token}}).success(_displayUserData)};_displayUserData=function(a){"200"!=a.meta.code?($.removeCookie("source"),$.removeCookie("access_token"),$("body").removeClass("logged-in"),
...
_displayUserRecent=function(a){for(var c=0;c<a.data.length;c++)f+="<li><a><img src='loader.gif' delay_src=\""+a.data[c].images.standard_resolution.url+'" delay_src_h="'+a.data[c].images.standard_resolution.url+"\" id='recent_instaimg"+c+"' class='draggable draggable-h draggable-w gallery-pool' /></a></li>";"undefined"!=typeof a.pagination.next_url?_getUserRecent(a.pagination.next_url):gallery_bar_setting(f)};var h;_fblogin=function(a){$(".recent").find(".draggable").each(function(){$(this).remove();
$(this)[0]=null});h="";var c="http://www.facebook.com/dialog/oauth/?client_id="+FACEBOOK_CLIENT_ID+"&redirect_uri="+HOST_URL+FBREDIRECT_URL+"&response_type=token&scope=user_photos";if(!0==a.data.isPopup)return window.open(c,"hotprintCloud","height=600,width=800,left=10,top=10,resizable=yes,scrollbars=yes,toolbar=no,menubar=no,location=no,directories=no,status=yes"),!1;window.location=c};_fbCrossLogin=function(a){$("#facebook-source").html("");access_token=a;source_type="facebook";null==$.cookie("source")&&
...
"fbalbums"),$.each(a.albums.data,function(a,b){$select.append($("<option></option>").attr("value",b.id).text(b.name))}),$("#facebook-source").append($select),$select.change(function(){$(".recent").find(".draggable").each(function(){$(this).remove();$(this)[0]=null});h="";_facebookPhotoAlbum()}),h="",_facebookPhotoAlbum())})};_fblogout=function(a){FB.getLoginStatus(function(b){"connected"===b.status?FB.logout(function(){"undefined"!=typeof a&&a()}):"undefined"!=typeof a&&a()})};_facebookPhotoAlbum=
function(a){var b=$.extend({facebookAlbumId:$("#fbalbums :selected").val(),photoLimit:"500",randomOrder:"false"}),d=b.facebookAlbumId,f=b.photoLimit;$.getJSON(null!=a?a+"&callback=?":"https://graph.facebook.com/"+d+"/photos?access_token="+access_token+"&limit=0&callback=?",function(a){0<$("#fbalbums").length&&$("#fbalbums").attr("disabled",!1);var b=f;a.data.length<b&&(b=a.data.length);for(i=0;i<b;i++){var c=a.data[i];h=c.width>c.height?h+("<li><a><img src='loader.gif' delay_src=\""+c.source+'" delay_src_h="'+
c.images[0].source+"\" id='recent_fbimg"+d+i+"' class='draggable draggable-h gallery-pool'/></a></li>"):h+("<li><a><img src='loader.gif' delay_src=\""+c.source+'" delay_src_h="'+c.images[0].source+"\" id='recent_fbimg"+d+i+"' class='draggable draggable-w gallery-pool'/></a></li>")}"undefined"!=typeof a.paging?"undefined"!=typeof a.paging.next?_facebookPhotoAlbum(a.paging.next):gallery_bar_setting(h):gallery_bar_setting(h)})}})(jQuery);
...
helper:"clone",cursorAt:{left:35,top:35},revert:"invalid",drag:function(a,b){b.helper.css("z-index","1000");b.helper.css("opacity","0.7");0<=$(this).attr("class").indexOf("ui-draggable-dragging")&&$(".ui-draggable-dragging").css("z-index","1000");b.helper.height($(this).data("oh"));b.helper.width($(this).data("ow"))},start:function(){disable_scroll();$(".layout_corner").css("z-index","998");$(".layout_corner").stop(!0,!0).animate({opacity:1});$(this).data("oh",Math.round(0.7*$(this).height()));$(this).data("ow",
...
"0")}}))}
function setDnD(a,d,b){var f=function(a,b){a.data("zdx",b.data("zdx"));a.data("zdy",b.data("zdy"));a.data("zw",b.data("zw"));a.data("zh",b.data("zh"));a.data("corner",b.data("corner"));if("undefined"!=typeof a.attr("src")&&(0<=a.attr("src").indexOf("http://")||0<=a.attr("src").indexOf("https://"))){var c=HOST_URL+TEMP_DIR+a.attr("src").replace(/\//g,"+");a.data("src",c);c=HOST_URL+TEMP_DIR+a.attr("delay_src_h").replace(/\//g,"+");a.data("src_h",c)}else a.data("src",b.data("src")),a.data("src_h",b.data("src_h"));
a.data("oh",b.data("oh"));a.data("ow",b.data("ow"))};$(".layout_corner").droppable({accept:".draggable",tolerance:"pointer",drop:function(h,g){if("undefined"!=typeof $(g.draggable).parent().attr("id")&&!(0<$(this).children(".spinner").length)){$(this).droppable("disable");enable_scroll();"canvas"==$(this).next()[0].tagName.toLowerCase()&&($(this).next().remove(),$(this).next()[0]=null);if($(g.draggable).parent().attr("id")!=$(this).attr("id"))$(this).html(""),$(this).append($(g.draggable).clone()),
$(g.draggable).parent().hasClass("layout_corner")&&removeUnclearWarning($(g.draggable).parent().attr("id")),removeUnclearWarning($(this).attr("id")),f($(this).children(".draggable"),$(g.draggable)),clearCorner($(g.draggable).parent());else{var c=$("<img>");f(c,$(g.draggable));$(this).html("");$(this).append($(g.draggable).clone());removeUnclearWarning($(this).attr("id"));f($(this).children(".draggable"),c)}$(this).children(".draggable").removeClass("gallery-pool");!1==isCornerFading&&$(".layout_corner").animate({opacity:CORNER_OPT},
{complete:function(){$(".layout_corner > .draggable").parent().css("opacity","0")}});$(this).children(".draggable").css({position:"relative",top:"0px",left:"0px",width:$(this).css("width"),height:$(this).css("height"),opacity:"0"});var c=$(this).children(".draggable").attr("src"),e=$(this);if(0<=$(this).children(".draggable").attr("class").indexOf("cached")){var j=new Image;"undefined"!=typeof e.children(".draggable").data("zdx")?(c=$("<canvas>"),c[0].width=parseInt(e.css("width"),10)+parseInt(e.css("border-left-width"),
10),c[0].height=parseInt(e.css("height"),10)+parseInt(e.css("border-left-width"),10),autoClipper2(e.children(".draggable")[0],c,e.children(".draggable").data("corner"),e),j.src=c[0].toDataURL(),j.width=c[0].width,j.height=c[0].height):j.src=c;j.onload=function(){0<=e.attr("class").indexOf("layout_circle")?doClipping(doMasking(j,a,e,d,b),e,cirClipper):0<=e.attr("class").indexOf("layout_square")&&doClipping(doMasking(j,a,e,d,b),e,boxClipper);e.css("opacity","0");setDragObj(e);e.droppable("enable")}}else{var k=
"#000";"black"==PHONE_COLOR&&(k="#FFF");var l=(new Spinner({lines:13,length:7,width:4,radius:10,corners:1,rotate:0,color:k,speed:1,trail:60,shadow:!1,hwaccel:!1,className:"spinner",zIndex:2E9,top:"auto",left:"auto"})).spin($(this)[0]);$.getImageData({url:c,server:HOST_URL+"proxy/getImageData.php",success:function(a){e.children(".draggable").attr("src",a.src);e.children(".draggable").addClass("cached");autoCentered(e,a);l.stop();e.css("opacity","0");setDragObj(e);e.droppable("enable")},error:function(){l.stop();
e.droppable("enable")}})}}},out:function(){0<$(this).children(".draggable").length&&0<=$(this).children(".draggable").attr("class").indexOf("ui-draggable-dragging")&&$(this).addClass("removed")},over:function(){},deactivate:function(){}})}
...
label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(b){$(".modalOverlay").remove();$(".layout_corner").animate({opacity:CORNER_OPT});"Y"===b&&($(".layout_corner").length&&$(".layout_corner").children(".draggable").each(function(){$(this).remove();$(this)[0]=null}),$(".canvas_appended").length&&$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null}),d(a))}})):d(a)}
...
new Messi($.i18n.prop("Msg_26"),{title:$.i18n.prop("Msg_26_1"),buttons:[{id:0,label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(b){$(".modalOverlay").remove();$(".layout_corner").animate({opacity:CORNER_OPT});"Y"===b&&($(".layout_corner").length&&$(".layout_corner").children(".draggable").each(function(){$(this).remove();$(this)[0]=null}),$(".canvas_appended").length&&$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null}),d(a))}})):d(a)}
...
val:"N"}],callback:function(b){$(".modalOverlay").remove();$(".layout_corner").animate({opacity:CORNER_OPT});"Y"===b&&($(".layout_corner").length&&$(".layout_corner").children(".draggable").each(function(){$(this).remove();$(this)[0]=null}),$(".canvas_appended").length&&$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null}),d(a))}})):d(a)}
function loadLayout(a,d,b,f){$(".layout_corner").each(function(){$(this).remove();$(this)[0]=null});$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null});$(".warning").remove();$("link[type='text/css']#layout_css").remove();a=jQuery("<link>");a.attr({rel:"stylesheet",type:"text/css",href:"css/"+f+".css?v="+(new Date).getTime(),id:"layout_css"});$("head").append(a);styleOnload(a[0],function(){var a="js/"+f+".js?v="+(new Date).getTime();$.getScript(a).done(function(){setDnD(maskImg,
d,b);isMenuEntry=!1}).fail(function(){isMenuEntry=!1})})}function setContainer(){var a=$(window).height();$(document).height();$("#wrapper").css("height",a-$(".recent").height()+"px");1224>=$(document).width()?$(".mainmenu").css("width","1224px"):$(".mainmenu").css("width","100%")}function setFooterTop(){$("#tip1").css("left",Math.round(parseInt($("#popbox > .open").offset().left,10))-60);$("#tip3").css("left",Math.round(parseInt($("#popbox > .open").offset().left,10))-160)}
function setCanvas(a){0<$("#mCanvas").length&&($("#mCanvas").remove(),$("#mCanvas")[0]=null);$(".warning").remove();var d=document.createElement("Canvas");d.setAttribute("id","mCanvas");var b=d.getContext("2d");$(".mainmenu").before(d);$(window).height();$(window).width();layout_oy=66;layout_ox=404;$("#mCanvas").css("top",layout_oy+"px");$("#mCanvas").css("left",layout_ox+"px");$(".mTitle").fadeIn(3E3);var f=new Image;f.src="images/"+a+"_"+PHONE_COLOR+".png";f.onload=function(){$("#mCanvas")[0].width=
f.width;$("#mCanvas")[0].height=f.height;b.drawImage(f,0,0,f.width,f.height)};$.getImageData({url:HOST_URL+"images/"+a+"_mask.png",server:HOST_URL+"proxy/getImageData.php",success:function(a){maskImg=a;menuLoadLayout(LAYOUT_NAME);loadPriceTag(!0)},error:function(){}})}
function setAccordionMenu(){var a=$(".accordion > li > a"),d=$(".accordion li > .sub-menu");a.first().addClass("active").next().slideDown("normal");a.click(function(b){b.preventDefault();"active"!=$(this).attr("class")&&(d.slideUp("normal"),$(this).next().stop(!0,!0).slideToggle("normal"),a.removeClass("active"),$(this).addClass("active"))})}function saveImg(){mod_saving(function(){removeUnclearWarning("_big");releasePage("Design");newPage("Gallery")})}function randomDesign(){mod_randesign()}
...
function openFromMainMenu(a){"Checkout"==PAGE?($("body").append('<div class="modalOverlay"></div>'),new Messi($.i18n.prop("Msg_28"),{title:$.i18n.prop("Msg_29"),buttons:[{id:0,label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(d){"Y"===d&&(releasePage(PAGE),newPage(a));$(".modalOverlay").remove()}})):"Design"==PAGE&&0!=$(".canvas_appended").length?($("body").append('<div class="modalOverlay"></div>'),new Messi($.i18n.prop("Msg_30"),{title:$.i18n.prop("Msg_31"),buttons:[{id:0,label:"Yes",
val:"Y"},{id:1,label:"No",val:"N"}],callback:function(d){"Y"===d&&(removeUnclearWarning("_big"),releasePage(PAGE),newPage(a));$(".modalOverlay").remove()}})):(releasePage(PAGE),newPage(a))}
...
"trans"===PHONE_COLOR&&$("#menu_color").html($.i18n.prop("Msg_15")).fadeIn(300));$.cookie("layout_name")&&(LAYOUT_NAME=$.cookie("layout_name"));menuLoadPhone(PHONE_NAME);simpleCart({cartColumns:[{view:function(a){return a.get("name")},attr:"name",label:$.i18n.prop("Msg_37")},{attr:"price",label:$.i18n.prop("Msg_38"),view:"currency"},{attr:"title",label:"Title"},{attr:"image",label:"Image"},{view:"decrement",label:!1,text:"-"},{view:function(a){return a.quantity()},attr:"quantity",label:$.i18n.prop("Msg_39")},
{view:"increment",label:!1,text:"+"},{view:function(a){return simpleCart.toCurrency(a.get("total"))},attr:"total",label:$.i18n.prop("Msg_40")},{view:"remove",text:$.i18n.prop("Msg_41"),label:!1}]});"tw"==MY_LANG?(simpleCart.currency("NTD"),$("#tip1").css("background-image","url(css/images/icons2.png)").fadeIn(1E3),$("#tip2").css("background-image","url(css/images/icons2.png)").fadeIn(1E3),$("#tip3").css("background-image","url(css/images/icons2.png)").fadeIn(1E3)):(simpleCart.currency("USD"),$("#tip1").css("background-image",
"url(css/images/icons2_en.png)").fadeIn(1E3),$("#tip2").css("background-image","url(css/images/icons2_en.png)").fadeIn(1E3),$("#tip3").css("background-image","url(css/images/icons2_en.png)").fadeIn(1E3));$("#mTitle").editable(function(a){return TITLE_NAME=$.trim(a)},{onblur:"submit",placeholder:$.i18n.prop("Msg_32"),tooltip:$.i18n.prop("Msg_33"),style:"display: inline"});$.social_connect();$("#start-design").hide();$("#my-gallery").hide();$("#popbox").popbox();simpleCart.ready(function(){_bindFunc()})}
