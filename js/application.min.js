...
success:function(a){b.children(".draggable").attr("src",a.src);b.children(".draggable").addClass("cached");autoCentered(b,a);k.stop();b.css("opacity","0");setDragObj(b);b.droppable("enable")},error:function(){k.stop();b.droppable("enable")}})}}},out:function(){0<$(this).children(".draggable").length&&0<=$(this).children(".draggable").attr("class").indexOf("ui-draggable-dragging")&&$(this).addClass("removed")},over:function(){},deactivate:function(){}})}
