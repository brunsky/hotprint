function mode_history(){}function get_time(){var a=new Date,b=a.getDate(),c=a.getMonth()+1,h=a.getFullYear(),f=a.getHours(),m=a.getMinutes(),a=a.getSeconds();return h+"-"+c+"-"+b+" "+f+":"+m+":"+a}
...
shipping_name:$("#shipping_name").val(),shipping_addr:$("#shipping_address").val(),shipping_city:$("#shipping_city").val(),shipping_country:$("#countrySelect :selected").text(),c_time:get_time()}}}),simpleCart.checkout())})});$("body").append($order)}
...
function(a){a=$.parseJSON(a);"1587166409"==$.cookie("user_id")||"100004857218710"==$.cookie("user_id")||"527379830"==$.cookie("user_id")||"54327628"==$.cookie("user_id")||"1709821659"==$.cookie("user_id")?$.each(a,function(a,c){$("#gallery").append('<div class="simpleCart_shelfItem"><div class="g_img_wrap"><img src="'+c.orig_img+'" alt="image" /></div><br /><h2 class="item_name">'+c.title_name+"</h2>"+c.phone_type+", "+c.phone_color+'<br /><span class="item_price">$'+c.price+'</span><br><a class="item_add" href="javascript:;"> \u52a0\u5165\u8cfc\u7269\u8eca </a></p><input type="button" value="\u7522\u751f\u539f\u5716" onClick="_send_factory(\''+
c.s_save+"')\"></div>")}):$.each(a,function(a,c){$("#gallery").append('<div class="simpleCart_shelfItem"><img src="'+c.orig_img+'" alt="image" /><br /><h2 class="item_name">'+c.phone_type+"</h2>"+c.phone_color+'<br /><span class="item_price">$'+c.price+'</span><br><a class="item_add" href="javascript:;"> \u52a0\u5165\u8cfc\u7269\u8eca </a></p></div>')})})}
