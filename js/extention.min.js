...
function checkValid(){var a=!0;$(".order :input").each(function(){""==$(this).val()&&"coupon_no"!=$(this).attr("id")&&($(this).after("<span class='fillcheck'><font color='red'>\u8acb\u586b\u5beb\uff01<font></span>"),a=!1)});return a}
...
parseFloat($(".simpleCart_total").html().replace("$",""),10).toFixed(2);a=(parseFloat($(".simpleCart_quantity").html().replace("$",""),10).toFixed(2)*a.value).toFixed(2);0>b-a&&(a=b);$(".simpleCart_total").html("").fadeIn(300).append("$"+(b-a).toFixed(2).toString());$("#coupon_no").after('<font color="red">\u5df2\u6298\u6263 $'+a+"</font>")}else"used"==a.value?$("#coupon_no").after('<font color="red">\u5df2\u7d93\u88ab\u4f7f\u7528</font>'):"invalid"==a.value?$("#coupon_no").after('<font color="red">\u7121\u6548\u7684\u6298\u6263\u78bc</font>'):
