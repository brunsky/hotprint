...
trail:60,shadow:!1,hwaccel:!1,className:"spinner",zIndex:2E9,top:"auto",left:"auto"})).spin($(this)[0]);$.getImageData({url:a,server:HOST_URL+"proxy/getImageData.php",success:function(a){b.children(".draggable").attr("src",a.src);b.children(".draggable").addClass("cached");0<=b.attr("class").indexOf("layout_circle")?doClipping(doMasking(a,maskImg,b,layout_ox,layout_oy),b,cirClipper):0<=b.attr("class").indexOf("layout_square")&&doClipping(doMasking(a,maskImg,b,layout_ox,layout_oy),b,boxClipper);b.css("opacity",
"0");m.stop();setDragObj(b)},error:function(){m.stop()}})})}
