...
simpleCart.bind("update",function(){$("#table_sty").html("");$("#table_sty").append('<tr><td width="5%" class="title">\u3000</td><td width="30%" class="title">\u540d \u7a31</td><td width="20%" class="title">\u50f9 \u683c</td><td width="10%" class="title">\u6578 \u91cf</td><td width="20%" class="title">\u5c0f \u8a08</td><td width="15%" class="title">&nbsp;</td></tr>');$(".itemRow").each(function(){console.log($(this).children(".item-price").html());$("#table_sty").append('<tr><td><img src="'+$(this).children(".item-image").html()+
'" width="40" height="68" /></td><td>'+$(this).children(".item-title").html()+"</td><td>"+$(this).children(".item-price").html()+"</td><td>"+$(this).children(".item-quantity").html()+"</td><td>"+$(this).children(".item-total").html()+'</td><td><img id="cart2_'+$(this).attr("id")+'" style="cursor:pointer" src="css/images/delete.png" width="18" height="18" /></td></tr>');var a=$(this);$("#cart2_"+$(this).attr("id")).click(function(){a.find(".simpleCart_remove").click()})});$("#table_sty").append('<tr><td height="38" class="title">&nbsp;</td><td class="title">&nbsp;</td><td class="title">&nbsp;</td><td class="title">&nbsp;</td><td class="title">&nbsp;</td><td class="title">&nbsp;</td></tr>');
$("#table_sty").append('<tr><td colspan="4" class="amount">\u7e3d\u8a08 '+$(".simpleCart_total").html()+'\u3000</td><td style="border-bottom: none;"><div class="checkout">\u7d50\u5e33</div></td></tr>');$(".checkout").click(function(){releasePage("Gallery");newPage("Checkout")});$(".item-decrement").css("padding-right","12px");$(".item-quantity").css("padding-right","12px");$(".headerRow > .item-total").css("padding-left","100px");$("#gallery").css("top",Math.round(parseInt($(".shopping_cart2").css("top")))+
$(".shopping_cart2").height()+50+"px");"$0.00"==$(".simpleCart_total").html()||""==$(".simpleCart_total").html()?$(".checkout").hide():$(".checkout").show()});simpleCart.update();$.cookie("user_id")&&$.post("db/retrive_gallery.php",{userid:$.cookie("user_id")},function(a){$("#gallery").append('<p align="center" style="font-size:20px;"><strong>\u6211\u7684\u8a2d\u8a08</strong></p>');a=$.parseJSON(a);$.each(a,function(a,c){var g="",g="USD"==c.currency?"US$":"NTD"==c.currency?"NT$":"US$";$("#gallery").append('<div class="simpleCart_shelfItem"><div class="list_pic"><img src="'+
c.orig_img+'" alt="image" width="120" height="202"/></div><span class="item_image" style="display:none">'+c.orig_img+'</span><div class="list_txt"><p><strong class="item_title">'+c.title_name+'</strong><span class="item_name" style="display:none">'+c.s_name+"</span></p><p>"+c.phone_type+" / "+c.phone_color+'</p><p><span class="item_price">'+g+c.price+'</span></p><a class="item_add" href="javascript:;"><img src="css/images/add_shoppingcar.png" width="18" height="18" /></a></div>')})})}
