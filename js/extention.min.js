...
function(){j+=k;return j+"%"});var c=a.cornerStyle.split(";"),q={},s="",t;for(t in c)s=c[t].split(":"),q[$.trim(s[0])]=$.trim(s[1]);var d=$("<div></div>");d.css("position","absolute");d.css("top",Math.round(parseInt(q.top),10)*scaling+"px");d.css("left",Math.round(parseInt(q.left),10)*scaling+"px");d.css("width",Math.round(parseInt(q.width),10)*scaling+"px");d.css("height",Math.round(parseInt(q.height),10)*scaling+"px");d.css("border","6px solid silver");d.addClass(a.cornerClass);d.attr("id",a.cornerId);
...
"%"});var c=b.cornerStyle.split(";"),e={},d="",f;for(f in c)d=c[f].split(":"),e[$.trim(d[0])]=$.trim(d[1]);var g=$("<div></div>");g.css("position","absolute");g.css("top",Math.round(parseInt(e.top),10)*scaling+"px");g.css("left",Math.round(parseInt(e.left),10)*scaling+"px");g.css("width",Math.round(parseInt($("body").find("#"+b.cornerId).css("width")),10)*scaling+"px");g.css("height",Math.round(parseInt($("body").find("#"+b.cornerId).css("height")),10)*scaling+"px");g.css("border","6px solid silver");
