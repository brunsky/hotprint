...
function _randesign(){$(".layout_corner").css("opacity",CORNER_OPT);$(".layout_corner").length&&$(".layout_corner").children(".draggable").each(function(){removeUnclearWarning($(this).parent().attr("id"));$(this).remove();$(this)[0]=null});$(".canvas_appended").length&&$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null});$(".layout_corner").each(function(){var a=Math.floor(Math.random()*$(".gallery-pool").length);$(this).append($($(".gallery-pool")[a]).clone());$(this).children(".draggable").removeClass("gallery-pool");
$(this).children(".draggable").data("oh",Math.round(0.7*$(".gallery-pool")[a].height));$(this).children(".draggable").data("ow",Math.round(0.7*$(".gallery-pool")[a].width));$(this).children(".draggable").css({position:"relative",top:"0px",left:"0px",width:$(this).css("width"),height:$(this).css("height"),opacity:"0"});var a=$(this).children(".draggable").attr("src"),b=$(this),c=HOST_URL+TEMP_DIR+a.replace(/\//g,"+");$(this).children(".draggable").data("src",c);c=HOST_URL+TEMP_DIR+$(this).children(".draggable").attr("delay_src_h").replace(/\//g,
"+");$(this).children(".draggable").data("src_h",c);c="#000";"black"==PHONE_COLOR&&(c="#FFF");var e=(new Spinner({lines:13,length:7,width:4,radius:10,corners:1,rotate:0,color:c,speed:1,trail:60,shadow:!1,hwaccel:!1,className:"spinner",zIndex:2E9,top:"auto",left:"auto"})).spin($(this)[0]);$.getImageData({url:a,server:HOST_URL+"proxy/getImageData.php",success:function(a){b.children(".draggable").attr("src",a.src);b.children(".draggable").addClass("cached");autoCentered(b,a);b.css("opacity","0");e.stop();
setDragObj(b)},error:function(){e.stop()}})})}
function clearDesign(){!(0<$(".layout_corner").children(".spinner").length)&&0!=$(".canvas_appended").length&&($("body").append('<div class="modalOverlay"></div>'),new Messi($.i18n.prop("Msg_68"),{title:$.i18n.prop("Msg_69"),buttons:[{id:0,label:"Yes",val:"Y"},{id:1,label:"No",val:"N"}],callback:function(a){"Y"===a&&($(".layout_corner").length&&$(".layout_corner").children(".draggable").each(function(){removeUnclearWarning($(this).parent().attr("id"));$(this).remove();$(this)[0]=null}),$(".canvas_appended").length&&
$(".canvas_appended").each(function(){$(this).remove();$(this)[0]=null}));$(".modalOverlay").remove();$(".layout_corner").animate({opacity:CORNER_OPT})}}))}function styleOnload(a,b){a.attachEvent?a.attachEvent("onload",b):setTimeout(function(){poll(a,b)},0)}
function poll(a,b){if(!b.isCalled){var c=!1;if(/webkit/i.test(navigator.userAgent))a.sheet&&(c=!0);else if(a.sheet)try{a.sheet.cssRules&&(c=!0)}catch(e){1E3===e.code&&(c=!0)}c?setTimeout(function(){b()},1):setTimeout(function(){poll(a,b)},1)}}var keys=[37,38,39,40];function preventDefault(a){a=a||window.event;a.preventDefault&&a.preventDefault();a.returnValue=!1}function keydown(a){for(var b=keys.length;b--;)if(a.keyCode===keys[b]){preventDefault(a);break}}function wheel(a){preventDefault(a)}
