...
$("<div class='warning_big'></div>"),$warning_big.css("position","absolute"),$warning_big.css("top",20+layout_oy+"px"),$warning_big.css("left",370+layout_ox+"px"),$warning_big.html('<img src="../css/images/warning.png" align="absmiddle"><span style="font-size: 16px; color: grey">'+$.i18n.prop("Msg_71")+"</span></img>"),$("body").append($warning_big))}else!0==IS_UNCLEAR&&(t<=b&&d<=c)&&(IS_UNCLEAR=!1,removeUnclearWarning(e.attr("id")))}
