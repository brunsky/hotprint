		...
		generateSimpleCart = function (space) {
			...
			var selectorEngines = {
				...
				currencies = {
					...
					"NTD": { code: "NTD", symbol: "NT&#36;", name: "New Taiwan Dollar" },
			...
			simpleCart.Item._ = simpleCart.Item.prototype = {
				...
				reservedFields: function () {
					return ['quantity', 'id', 'item_number', 'price', 'name', 'shipping', 'tax', 'taxRate', 'currency'];
				},
